...
const categoriesData = [
  ...
  { title: 'African Print Pants', collections: ['Clothing'], departments: ['Women', 'Men', 'Kids'], brands: ['Vlisco', 'Woodin', 'GTP', 'Steve French', 'Orange Culture', 'Osei-Duro'], attributes: ['Size', 'Color', 'Fit', 'Material', 'Print/Pattern', 'Occasion'], variantAttributes: ['Size', 'Color'] },
