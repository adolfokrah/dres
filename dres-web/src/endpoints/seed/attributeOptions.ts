...
const attributeOptionsData: Record<string, AttributeOptionData[]> = {
  ...
  Fit: [
    { name: 'Slim Fit', slug: 'slim-fit', categories: ['Coats', 'Jackets', 'Dresses', 'Tops', 'Shirts', 'Blouses', 'T-Shirts', 'Sweaters', 'Cardigans', 'Trousers', 'Jeans', 'Shorts', 'Skirts', 'Suits', 'Blazers', 'Trench Coats', 'Knitwear', 'Activewear', 'African Print Shirts', 'African Print Trousers'] },
    { name: 'Regular Fit', slug: 'regular-fit', categories: ['Coats', 'Jackets', 'Dresses', 'Tops', 'Shirts', 'Blouses', 'T-Shirts', 'Sweaters', 'Cardigans', 'Trousers', 'Jeans', 'Shorts', 'Skirts', 'Suits', 'Blazers', 'Trench Coats', 'Knitwear', 'Activewear', 'African Print Shirts', 'African Print Trousers'] },
    { name: 'Relaxed Fit', slug: 'relaxed-fit', categories: ['Coats', 'Jackets', 'Dresses', 'Tops', 'Shirts', 'Blouses', 'T-Shirts', 'Sweaters', 'Cardigans', 'Trousers', 'Jeans', 'Shorts', 'Skirts', 'Suits', 'Blazers', 'Trench Coats', 'Knitwear', 'Activewear', 'African Print Shirts', 'African Print Trousers'] },
    { name: 'Oversized', slug: 'oversized', categories: ['Coats', 'Jackets', 'Dresses', 'Tops', 'Shirts', 'Blouses', 'T-Shirts', 'Sweaters', 'Cardigans', 'Trousers', 'Shorts', 'Suits', 'Blazers', 'Trench Coats', 'Knitwear', 'African Print Shirts', 'African Print Trousers'] },
    { name: 'Skinny', slug: 'skinny', categories: ['Trousers', 'Jeans', 'African Print Trousers'] },
    { name: 'Straight', slug: 'straight', categories: ['Trousers', 'Jeans', 'African Print Trousers'] },
    { name: 'Bootcut', slug: 'bootcut', categories: ['Trousers', 'Jeans', 'African Print Trousers'] },
    { name: 'Wide Leg', slug: 'wide-leg', categories: ['Trousers', 'Jeans', 'Shorts', 'African Print Trousers'] },
    { name: 'Baggy', slug: 'baggy', categories: ['Trousers', 'Jeans', 'Shorts', 'African Print Trousers'] },
    { name: 'Mom Fit', slug: 'mom-fit', categories: ['Jeans'] },
    { name: 'Dad Fit', slug: 'dad-fit', categories: ['Jeans'] },
    { name: 'Boyfriend Fit', slug: 'boyfriend-fit', categories: ['Jeans', 'Shirts', 'Blazers', 'African Print Shirts'] },
    { name: 'Girlfriend Fit', slug: 'girlfriend-fit', categories: ['Jeans'] },
    { name: 'Flare', slug: 'flare', categories: ['Trousers', 'Jeans', 'African Print Trousers'] },
    { name: 'Tapered', slug: 'tapered', categories: ['Trousers', 'Jeans', 'African Print Trousers'] },
    { name: 'Low Rise', slug: 'low-rise', categories: ['Trousers', 'Jeans', 'Shorts', 'Skirts', 'African Print Trousers'] },
    { name: 'Mid Rise', slug: 'mid-rise', categories: ['Trousers', 'Jeans', 'Shorts', 'Skirts', 'African Print Trousers'] },
    { name: 'High Rise', slug: 'high-rise', categories: ['Trousers', 'Jeans', 'Shorts', 'Skirts', 'African Print Trousers'] },
    { name: 'Cropped', slug: 'cropped', categories: ['Trousers', 'Jeans', 'Tops', 'Sweaters', 'Cardigans', 'Jackets', 'African Print Trousers'] },
    { name: 'Tailored', slug: 'tailored', categories: ['Suits', 'Blazers', 'Trousers', 'Shirts', 'Dresses', 'African Print Shirts', 'African Print Trousers'] },
  ],
  Length: [
