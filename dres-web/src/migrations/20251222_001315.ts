...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_language" AS ENUM('en', 'fr', 'de', 'es', 'it', 'pt', 'nl', 'ja', 'zh', 'ko');
  CREATE TYPE "public"."enum_users_currency" AS ENUM('USD', 'EUR', 'GBP', 'JPY', 'CAD', 'AUD', 'CHF', 'CNY', 'INR', 'GHS', 'NGN');
  CREATE TYPE "public"."enum_users_country" AS ENUM('US', 'GB', 'CA', 'AU', 'DE', 'FR', 'IT', 'ES', 'NL', 'JP', 'CN', 'IN', 'GH', 'NG', 'ZA', 'BR', 'MX');
  CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'user');
  CREATE TYPE "public"."enum_users_account_status" AS ENUM('active', 'banned', 'deleted');
  ...
  CREATE TABLE "users" (
  	...
  	"shop_name" varchar,
  	"photo_id" integer,
  	"language" "enum_users_language" DEFAULT 'en',
  	"currency" "enum_users_currency" DEFAULT 'USD',
  	"country" "enum_users_country",
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_users_country";
