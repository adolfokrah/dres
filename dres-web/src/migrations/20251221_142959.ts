...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "main_categories_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  ALTER TABLE "categories_rels" ADD CONSTRAINT "categories_rels_main_categories_fk" FOREIGN KEY ("main_categories_id") REFERENCES "public"."main_categories"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "main_categories_rels" ADD CONSTRAINT "main_categories_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."main_categories"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "main_categories_rels" ADD CONSTRAINT "main_categories_rels_variant_types_fk" FOREIGN KEY ("variant_types_id") REFERENCES "public"."variant_types"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_main_categories_fk" FOREIGN KEY ("main_categories_id") REFERENCES "public"."main_categories"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "categories_rels_main_categories_id_idx" ON "categories_rels" USING btree ("main_categories_id");
  CREATE UNIQUE INDEX "main_categories_slug_idx" ON "main_categories" USING btree ("slug");
  CREATE INDEX "main_categories_updated_at_idx" ON "main_categories" USING btree ("updated_at");
  CREATE INDEX "main_categories_created_at_idx" ON "main_categories" USING btree ("created_at");
  CREATE INDEX "main_categories_rels_order_idx" ON "main_categories_rels" USING btree ("order");
  CREATE INDEX "main_categories_rels_parent_idx" ON "main_categories_rels" USING btree ("parent_id");
  CREATE INDEX "main_categories_rels_path_idx" ON "main_categories_rels" USING btree ("path");
  CREATE INDEX "main_categories_rels_variant_types_id_idx" ON "main_categories_rels" USING btree ("variant_types_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_main_categories_id_idx" ON "payload_locked_documents_rels" USING btree ("main_categories_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "main_categories_rels" CASCADE;
